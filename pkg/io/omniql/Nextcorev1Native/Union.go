...
//RID get resource id
func (u *UnionReader) RID() Nextcorev1.ResourceIDReader {
	return u._rid
}
...
//Metadata ...
func (u *UnionReader) Metadata() (mr Nextcorev1.MetadataReader, err error) {
...
func (vu *VectorUnionReader) Get(i int) (item Nextcorev1.UnionReader, err error) {
